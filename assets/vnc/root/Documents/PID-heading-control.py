...
root.title("PID Heading Control")
...
parameters_pub = rospy.Publisher(
    f"/{DB_NAME}/PID_parameters", String, queue_size=1, dt_topic_type=TopicType.GENERIC
)
...
ref = tk.Label(root, text="heading ref (deg)", font=("calibre", 10, "bold"))
ref_entry = tk.Entry(root, textvariable=ref_var, font=("calibre", 10, "normal"))

v = tk.Label(root, text="speed ref (m/s)", font=("calibre", 10, "bold"))
...
sub_btn = tk.Button(root, text="Send", command=submit)
...
sub_stop_btn.grid(row=5, column=1)
